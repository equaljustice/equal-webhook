...
import guestAssistantRoutes from "./src/routes/guestAssistantAPI.js";
...
import geminiAdminRoutes from "./src/routes/geminiAdmin.js";
const APIrouter = express.Router();

APIrouter.use("/auth", authRoutes);
APIrouter.use("/assistant", guestAssistantRoutes);
...
APIrouter.use("/gemini-admin", geminiAdminRoutes);
