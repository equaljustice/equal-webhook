...
},
{
    ...
    "Parameter": "upi-pinshare-mode-phone-received-call-on-user-number-registered-with-bank",
    "Condition": "Yes",
    "LegalTrainingMaterial": `Include all the below 3 points in the generated document as they are very critical:
...
},
{
    ...
    "Parameter": "whether-website-or-app-where-pin-shared-in-bank-or-upi-app-name:",
    "Condition": "Website",
    "LegalTrainingMaterial": `Include all the below 4 points in the generated document as they are very critical:
...
},
{
    ...
    "Parameter": "upi-pin-share-with-bank-or-upiapp-officer-at-bank-office",
    "Condition": "Yes",
    "LegalTrainingMaterial": `Include the below point in the generated document as it is very very critical:
...
},
{
    "qId": "26",
    "Question": "Total amount of refund and compensation you wish to claim from the Bank? You may note that in addition to refund of the defrauded amount, the Banking Ombudsman can also provide compensation upto \u20b91 lakh for mental agony/ harassment/costs/fees etc. suffered by the complainant, and consumer Courts may even provide higher compensation.",
    "Parameter": "compensation-and-damages",
    "Condition": "Yes",
...
export const EmployeeTrainingData = [
    ...
    },
    {
        ...
        "Condition": "Yes",
        "LegalTrainingMaterial": "During the course of my employment, I was asked to act as a complainant or I was a witness in certain legal or law enforcement matters of the employer. The employer is notified to undertake all necessary actions to immediately replace my name with any other authorized person’s name as the complainant on behalf of the employer, and provide me with sufficient proof of such change. Further, if I am a witness or asked to be a witness in any legal or law enforcement proceedings by or against the employer, I shall not be bound by any confidentiality or other stipulations which will prevent me from discharging my duties as a witness."
    },
    {
        "qId": 10,
