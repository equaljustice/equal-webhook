...
},
{
    ...
    "Condition": "No",
    "LegalTrainingMaterial": "This transaction ocurred even when I have not shared my ATM Pin with anyone. This is a prima facie case of utter gross negligence and mala fide intent at the bank's side which may involve connivance of the bank's officer  including unauthorizedly sharing my information i.e. my ATM card details and my ATM Pin to cause wrongful harm to me. The onus is on the bank to demonstrate how a different person has withdrawn the money from the ATM by using my ATM pin which I never shared. The RBI has also mandated banks to not share customer information  and in this case there could be a possibility that the bank or its employee has access to my ATM card Pin and have shared the ATM details and ATM Pin to cause wrongful loss to me or the bank's systems were not strong to prevent a third party to access my ATM card Pin and undertake a fraudulent transaction. In fact the Supreme Court has also held that the development in means of communication  science & technology etc. have led to an enormous increase in economic crimes viz. phishing  ATM frauds etc. which are being committed by intelligent but devious individuals involving huge sums of public or government money. These are actually public wrongs or crimes committed against society and the gravity and magnitude attached to these offenses is concentrated on the public at large."
},
{
    "qId": "7",
...
},
{
    ...
    "Condition": "No",
    "LegalTrainingMaterial": "Bank is required by the RBI guidelines to implement robust surveillance / monitoring of card transactions and related technologies including geo tagging and IP address mapping. As I was not present in that city or different country (as per users response) when the fraudulent transction took place, bank failing to comply with RBI directions has caused this loss to me."
},
{
    "qId": "35",
    "Question": "Were you present in that city in India or the other country during the time of the ATM transaction.",
    ...
    "Condition": "Yes",
    "LegalTrainingMaterial": "RBI has mandated the bank to implement security measures including transaction behavior checks and CCTV surveillance to ensure no fraudulent and unauthorized transactions are carried out from the ATMs. Although I was present in that different city or different country (as per users response) when the fraudulent transaction took place, the bank however did not implement adequate monitoring / surveillance technologies including CCTV survellance to identify that a person other than me is withdrawing money from the ATM and have immediately blocked the ATM to dispense the money  and also did not take adequate steps to ensure the transaction is not a fraud transaction as it occurred from an ATM which I have not used in the past to withdraw any money."
},
{
    "qId": "36",
